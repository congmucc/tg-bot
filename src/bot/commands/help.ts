...
🚀 *高级交易系统*
---------------------
/trade [买/卖] [代币对] [数量] [滑点%] - 智能市价单
/trade limit [代币对] [价格] [数量] - 限价单
/trade stop [代币对] [止损价] [数量] - 止损单
/trade dca [代币对] [总金额] [周期] - DCA定投
/trade twap [代币对] [金额] [批次] [间隔] - TWAP分批
/trade analyze [代币对] [数量] - 深度交易分析
/trade route [代币对] [金额] - 智能路由分析
/trade mev [代币对] [金额] - MEV风险分析
